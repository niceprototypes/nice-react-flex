...
const isResponsiveObject = (value) => typeof value === "object" &&
    value !== null &&
    (niceReactStyles.BREAKPOINT_SMALL in value || niceReactStyles.BREAKPOINT_MEDIUM in value || niceReactStyles.BREAKPOINT_LARGE in value);
...
const getBreakpointValue = (value, breakpoint) => {
    ...
    return breakpoint === niceReactStyles.BREAKPOINT_SMALL ? value : undefined;
};
...
const getSpacingValue = (spacing, breakpoint) => {
    ...
    if (typeof spacing === "string") {
        if (breakpoint === niceReactStyles.BREAKPOINT_SMALL) {
...
const FlexStyled = styled.div.withConfig({
  ...
  ${(props) => styleFlex(niceReactStyles.BREAKPOINT_SMALL, props)}

  ${niceReactStyles.getBreakpoint(niceReactStyles.BREAKPOINT_MEDIUM).query} {
    ${(props) => styleFlex(niceReactStyles.BREAKPOINT_MEDIUM, props)}
  }

  ${niceReactStyles.getBreakpoint(niceReactStyles.BREAKPOINT_LARGE).query} {
    ${(props) => styleFlex(niceReactStyles.BREAKPOINT_LARGE, props)}
  }
`;
...
const normalizeProps = (props) => {
    ...
    breakpointProps.forEach((propName) => {
        ...
        if (value !== undefined && typeof value !== "object") {
            normalizedProps[propName] = { [niceReactStyles.BREAKPOINT_SMALL]: value };
        }
    });
